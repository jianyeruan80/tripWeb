...
.controller('DashCtrl', function ($scope, $timeout,$ionicLoading,publicService,toaster,$ionicActionSheet,$ionicPopup) {
...
FB.api("/"+id,  function (response) {
        if (response && !response.error) {
          ...
          $scope.messageData.shareLink=response.actions[0].link;
...
FB.ui({
     method: 'feed',
     name: 'share Title',
     link: 'http://m.menusifu.com/share',
    ...
    FB.login(function (response) { 
        ...
        if (response.authResponse) { 
          ...
          $scope.postFB();
            ...
            }, { scope: 'user_location,offline_access,publish_stream,publish_actions' }); 
